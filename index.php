  ...
  <body class="bg-light">
   ...
   ?>
    ...
    <div class="container availability-form">
        <div class="row">
            <div class="col-lg-12 bg-warning-subtle shadow p-4 rounded">
    ...
    <div class="container">
      <div class="row justify-content-between align-items-center ">
        <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
          <h2 class="mb-3 h-font custom-bg">TAI_HOTEL - KHÁCH SẠN 4 SAO VIỆT NAM</h2>
          
          <p style="font-size: 20px;"> TAI_HOTEL là thương hiệu hạng sang, các khách sạn của nó là các khách sạn thuộc phân khúc <b>4 sao</b>. 
          Do đó, thị trường mà các khách sạn này hướng tới đó là khách doanh nhân và khách nghỉ dưỡng có nhu cầu cao về dịch vụ, tiện nghi.
          Vị trí: 88 Đồng Khởi, Phường Bến Nghé, Quận 1, Tp. Hồ Chí Minh
          Khách sạn TAI_HOTEL Sài Gòn nằm ngay trung tâm của quận 1 chỉ cách các địa điểm nổi tiếng trong thành phố trong phạm vi bán kính 500m. 
          Khách sạn có tổng cộng 200 phòng được phân thành nhiều hạng phòng với cơ sở vật chất hiện đại. 
          Đến với khách sạn ở Sài Gòn này khách hàng sẽ bất ngờ trước các dịch vụ mà khách sạn cung cấp: 
          dịch vụ casino, hồ bơi, spa cao cấp,...
          </p>
        </div>
        <div class="col-lg-5 col-md-5 mb-4 order-lg-2 order-md-2 order-1">
          <img src="images/rooms/room1.jpg" class="w-100 rounded-start-circle">
        </div>
      </div>
    </div>
    <!-- Our Rooms -->
    <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">CÁC PHÒNG NỔI BẬT</h2>
    <div class="container">
        <div class="row">
            <?php
            ...
            while($room_data = mysqli_fetch_assoc($room_res))
            {
              ...
              $fea_q = mysqli_query($con,"SELECT f.name FROM `features`f 
                ...
                //btn booking___________________________________
                $book_btn = "";
                ...
                echo<<<data
                  ...
                  <div class="card border-0 shadow" style="max-width: 350px; margin:auto;">
                      ...
                      <div class="card-body">
                          ...
                          <h6 class="mb-4">$room_data[price] ₫ /Ngày</h6>
                          ...
                          <div class="d-flex justify-content-evenly mb-2">
                              $book_btn
                              <a href="room_details.php?id=$room_data[id]" class="btn btn-sm btn-outline-dark shadow-none">Xem Thêm</a>
                          </div>
                      </div>
                  </div>
                </div>
    ...
    <!-- Our facilities -->
    <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">DỊCH VỤ VÀ TIỆN ÍCH</h2>
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
          <?php
              ...
              while($row = mysqli_fetch_assoc($res)){
                echo <<<data
                    <div class="col-lg-2 col-md-2 text-center bg-warning-subtle rounded shadow py-4 my-3">
    ...
    <!--testimonials-->
    <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">XẾP HẠNG VÀ ĐÁNH GIÁ</h2>
        ...
        <div class="swiper swiper-testimonials">
            <div class="swiper-wrapper mb-5">
                ...
                <!-- <div class="swiper-slide bg-white p-4">
                   ...
                   <p>Your details must match with your ID (Passport, driving license, etc.)
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="bg-white p-4 rounded mb-4">
                    <h5>Điện thoại</h5>
                    <a href="tel: +<?php echo $contact_r['pn1'] ?>" class="d-inline-bock mb-2 text-decoration-none text-dark">
   ...
   <?php 
    if(isset($_GET['account_recovery']))
    {
      ...
      {
        // alert("success","Invalid or Expire Link !");
        echo<<<showModal
          <script>
