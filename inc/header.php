   <nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-warning-subtle px-lg-3 py-lg-2 shadow-sm sticky-top">
            ...
            <div class="modal-content">
                <form id="login-form">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Email / Điện thoại</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="forgot-form">
                    ...
                    <div class="modal-body">
                        <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                                Lưu ý: link phục hồi sẽ gữi đến Email bạn đã đăng ký !
                        </span>
                        <div class="mb-4">
                            <label class="form-label">Email</label>
                            <input name="email" type="email" class="form-control shadow-none" required>
