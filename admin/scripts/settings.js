...
function upd_general(site_title_val, site_about_val) {
  ...
  xhr.onload = function () {
    ...
    if (this.responseText == 1) {
      ...
      alert("error", "Không có Thay Đổi được Thực Hiện!");
    }
  };
  xhr.send(
    "site_title=" +
...
function add_member() {
  ...
  xhr.onload = function () {
    ...
    if (this.responseText == "inv_img") {
      alert("error", "Chỉ file JPG, PNG là hợp lệ!");
    } else if (this.responseText == "inv_size") {
      alert("error", "Ảnh phải đảm bảo < 2MB!");
    } else if (this.responseText == "upd_failed") {
      alert("error", "Ảnh tải lên thất bại. Server shutdown!");
    } else {
