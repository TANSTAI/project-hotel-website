<?php
    ...
    if(isset($_POST['add_room']))
    {
        ...
        $values = [$frm_data['name'], $frm_data['area'],
                  $frm_data['price'],$frm_data['quantity'],$frm_data['adult'],$frm_data['children'],$frm_data['desc']];
        ...
        {
            $flag = 0;
            die('Query cannot be prepaired - insert');
        }
    ...
    if(isset($_POST['get_all_rooms']))
    {
        ...
        while($row = mysqli_fetch_assoc($res)){
            ...
            <tr class='align-middle'>
                <td>$i</td>
                <td>$row[name]</td>
                <td>$row[area] <span>(m<sup>2</sup>)</span></td>
                <td>
    ...
    if(isset($_POST['edit_room'])){
        ...
        $values = [$frm_data['name'], $frm_data['area'],
                  $frm_data['price'],$frm_data['quantity'],$frm_data['adult'],$frm_data['children'],$frm_data['desc'],$frm_data['room_id']];
    ...
    {
        $frm_data = filteration($_POST);
        $img_r = uploadImage2($_FILES['image'],ROOMS_FOLDER);
    ...
    if(isset($_POST['rem_image']))
    {
        ...
        $re_q = "SELECT * FROM `room_images` WHERE `sr_no`=? AND `room_id`=?";
        $res = select($re_q,$values,'ii');
