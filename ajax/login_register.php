<?php
    ...
    if(isset($_POST['register']))
    {
        ...
        //match password and comfirm password
        if($data['pass'] != $data['cpass'])
        {
            echo 2;//'pass_mismatch'
            exit;
        }
        ...
        if(mysqli_num_rows($u_exist)!=0)
        {
            ...
            //'email_already' : 'phone_already';
            exit;
        }
        //upload user image to server 
        $img = uploadUserImage2($_FILES['profile']);
